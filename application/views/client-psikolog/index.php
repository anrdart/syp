         ...
         <div class="card shadow mb-4">
             <div class="card-header py-3">
                 ...
                 <div class="d-sm-flex align-items-center justify-content-between mb-0">
                     ...
                     <a class="btn btn-sm btn-outline-danger" href="<?= base_url('client/importCsv'); ?>"><span class="far fa-lg fa-fw fa-file-excel"></span>Import Data CSV</a>
                 </div>
             </div>
                             ...
                             <tr>
                                 <?php
                                    ...
                                    foreach ($client as $c) { ?>
                                     ...
                                     <td>
                                         <a href="<?= base_url('adminlog/updateClient/') . $c['id']; ?>" class="badge badge-success"><i class="fas fa-edit"></i> Ubah</a>
                                         <a href="<?= base_url('adminlog/hapusClient/') . $c['id']; ?>" class="badge badge-danger" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $c['nama']; ?> ?');"><i class="fas fa-trash"></i> Hapus</a>
                                     </td>
                             </tr>
                         <?php } ?>
                         </tr>
