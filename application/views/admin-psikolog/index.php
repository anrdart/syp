            ...
            <div class="card border-left-danger shadow h-100 py-2 bg-primary">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="<?= base_url('client'); ?>"><i class="fas fa-users fa-3x text-warning"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-tools">
                        <div class="input-group input-group-sm" style="width: 300px;">
                            ...
                            <div class="input-group-append">
                                ...
                                <a class="text-danger" href="<?php echo base_url('adminlog/client'); ?>"><i class="fas fa-search mt-2 float-right"> Tampilkan</i></a>
                            </div>
                        </div>
                    </div>
                </div>
